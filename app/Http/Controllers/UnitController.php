...
class UnitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('message','Unit Info Created');
    }
    ...
    public function show(Unit $unit)
    {
        ...
        Unit::statusUnit($unit->id);
        return redirect('/unit')->with('message','Status Updated');
    }
    ...
    public function destroy(Unit $unit)
    {
        ...
        return back()->with('delete','Unit info Deleted');
    }
}
