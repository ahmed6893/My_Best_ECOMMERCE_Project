                        ...
                        <div class="offcanvas offcanvas-start offcanvas-collapse w-md-50" tabindex="-1" id="offcanvasCategory" aria-labelledby="offcanvasCategoryLabel">
                            ...
                            <div class="offcanvas-body ps-lg-2 pt-lg-0">
                                ...
                                <div class="mb-8 position-relative">
                                    ...
                                    <!-- Banner Image -->
                                    <!-- img -->
                                    <img src="{{asset('/')}}website/assets/images/banner/assortment-citrus-fruits.png" alt="" class="img-fluid rounded" />
                                    <!-- Banner Image -->
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center position-relative">
                                            ...
                                            <a href="shop-single.html">
                                                <!-- img -->
                                                <img src="{{asset($product->product_image)}}" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" />
                                            </a>
                                            <!-- action btn -->
                                        ...
                                        <h2 class="fs-6"><a href="{{route('product.details',[$product->id])}}" class="text-inherit text-decoration-none">{{$product->name}}</a></h2>
                                        <div>
                                            <!-- rating -->
