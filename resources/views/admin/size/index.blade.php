                            ...
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-md-6 col-12 mb-2 mb-md-0">
                                    ...
                                    <form class="d-flex" role="search">
                                        <input class="form-control" type="search" placeholder="Search Size" aria-label="Search" />
                                    </form>
                                </div>
                                <!-- select option -->
                                ...
                                <table class="table table-centered table-hover mb-0 text-nowrap table-borderless table-with-checkbox">
                                    ...
                                    @foreach($sizes as $size)
                                        <tr>
                                            ...
                                            <td><a href="#" class="text-reset">{{$size->name}}</a></td>
                                            <td><a href="#" class="text-reset">{{$size->code}}</a></td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <form action="{{route('size.destroy',$size->id)}}" method="post" onclick="return confirm('Are You Sure..')">
                                                                @method('DELETE')
                                                                @csrf
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="{{route('size.edit',$size->id)}}">
