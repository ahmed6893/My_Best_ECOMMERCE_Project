            ...
            <div class="row mb-8">
                <div class="col-md-12">
                    <div class="d-md-flex justify-content-between align-items-center">
                        <!-- page header -->
                        <div>
                            <h2 class="text-primary">Edit Size</h2>
                            <!-- breacrumb -->
                            ...
                            <div class="card-body p-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input type="text" class="form-control" value="{{$size->name}}" name="name" placeholder="Size Name" required />
                                    </div>

                                    <div class="mb-3 col-lg-6">
                                        <label class="form-label">Size Name</label>
                                        <input type="text" class="form-control" value="{{$size->code}}" name="code" placeholder="Size Code" required />
                                    </div>
