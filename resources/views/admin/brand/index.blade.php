                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <form action="{{route('brand.destroy',$brand->id)}}" method="post" onclick="return confirm('Are You Sure..')">
                                                                @method('DELETE')
                                                                @csrf
                                                        ...
                                                        <li>
                                                            @if($brand->status == 1)
                                                                <a href="{{route('brand.show',$brand->id)}}" class="badge bg-light-danger dropdown-item text-dark-danger ">Unpublished</a>
                                                            @else
                                                                <a href="{{route('brand.show',$brand->id)}}" class="badge bg-light-primary dropdown-item text-dark-primary">Published</a>
                                                            @endif
                                                        </li>
                                                    </ul>
