            ...
            <div class="row mb-8">
                <div class="col-md-12">
                    <div class="d-md-flex justify-content-between align-items-center">
                        <!-- page header -->
                        <div>
                            <h2 class="text-primary">Add New Color</h2>
                            <!-- breacrumb -->
                            ...
                            <div class="card-body p-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input type="color" class="form-control" name="code" placeholder="Color Code" required />
                                    </div>

                                    <div class="col-lg-12">
                                        <button class="btn btn-primary" type="submit">Create Color</button>
