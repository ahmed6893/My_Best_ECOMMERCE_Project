                        ...
                        <div class="card-body p-6">
                            ...
                            <div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="stock_amount" placeholder="Enter Stock Amount" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-6 card-lg">
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="regular_price" class="form-control" placeholder="here" />
                            </div>
                            <!-- input -->
                            <div class="mb-3">
                                <label class="form-label">Sale Price</label>
                                <input type="text" class="form-control" name="selling_price" placeholder="here" />
                            </div>
                        </div>
                    </div>
                    <!-- card -->
                    <div class="card mb-6 card-lg">
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" name="meta_title" placeholder="Title"></textarea>
                            </div>
