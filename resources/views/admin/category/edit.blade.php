            ...
            <div class="row mb-8">
                <div class="col-md-12">
                    <div class="d-md-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{route('category.index')}}" class="btn btn-light">Back to Categories</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body p-6">
                                ...
                                <div class="mb-4 d-flex">
                                    <div class="position-relative">
                                        <img class="image icon-shape icon-xxxl bg-light rounded-4" src="{{asset($category->images)}}" alt="Image" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input type="text" class="form-control" value="{{$category->name}}" name="name" placeholder="Category Name" required />
                                    </div>
                                    <div></div>
                                    <!-- input -->
